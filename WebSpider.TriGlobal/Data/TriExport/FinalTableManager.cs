...
namespace WebSpider.TriGlobal.Data.TriExport
{
    public class FinalTableManager : DataManager
    {
        ...
        public List<FinalTable> GetDataByTriPart(String AID_PART)
        {
        ...
        #region [ Save ]
        public int SaveTriPart(FinalTable finalTable)
        {
            return SaveTriPart(finalTable.ID, finalTable.UPC, finalTable.VDR_PART, finalTable.VDR_IT_DSC
                , finalTable.Image_Folder, finalTable.Tri_SOURCE_ID, finalTable.Tri_PART, finalTable.Tri_COST == null ? 0 : (decimal) finalTable.Tri_COST
                , finalTable.Tri_IMG1, finalTable.Tri_IMG2, finalTable.Tri_VENDOR, finalTable.Tri_INV
                , finalTable.Tri_LastUpdate);
        }
        ...
        {
            var count = GetDataByTriPart(AID_PART).Count();
            if (count == 1)
        ...
        public int SaveTriPart(Int64 ID, String UPC, String VDR_PART, String VDR_IT_DSC, String Image_Folder, String AID_SOURCE_ID, 
        ...
        public int ValidTriProduct(string VDR_PART)
        {
        ...
        public int UpdateFlagsByTriProduct(String AID_PART, Boolean AID_ClearanceZone
        ...
        public List<FinalTable> GetAllTriProducts()
        {
