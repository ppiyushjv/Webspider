...
namespace WebSpider.Data.DatabaseManager
{
    ...
    /// </summary>
    public class OleDbDataManager : DataAccessBase, IDisposable
    {
        ...
        private static object OleDbLock = new object();
        #endregion
        ...
        public OleDbDataManager(string ConnectionString, string StoredProcName)
        ...
        public OleDbDataManager(string ConnectionString, string SqlString, bool IsTextQuery)
        {
        ...
        public DataTable GetTable()
        {
            ...
            //{
            //    oCmd.Parameters.Add("ResultSet", OleDbType.Structured).Direction=ParameterDirection.Output;                
            //}
        ...
        public DataSet GetDataSet()
        {
            ...
            //    {
            //        oCmd.Parameters.Add("ResultSet" + i.ToString(), OleDbType.Structured).Direction = ParameterDirection.Output; 
            //    } 
            //}
        ...
        private void InitQuery(OleDbCommand oCmd)
        {
            // set Connection
            blnLocalConn = (this.oConn == null);
            if (blnLocalConn)
            {
                oConn = new OleDbDataConnection();
            ...
            {
                //System.Diagnostics.Debug.Print(oItem.ToString() +" : "+ ((OleDbParameter)oItem).Value);
                oCmd.Parameters.Add((OleDbParameter)oItem);
            }
        }
        #endregion
        #endregion
        ...
        public void AddCharPara(string Name, int Size, char Value, QueryParameterDirection Direction)
        {
            ...
            OleDbParameter oPara = new OleDbParameter(Name, OleDbType.Char, Size);
            oPara.Direction = GetParaType(Direction);
            oPara.Value = oValue;
            this.oParameters.Add(oPara);
        }
        ...
        public void AddBoolPara(string Name, bool Value, QueryParameterDirection Direction)
        {
            ...
            OleDbParameter oPara = new OleDbParameter(Name, OleDbType.Boolean);
            oPara.Direction = GetParaType(Direction);
            oPara.Value = oValue;
            this.oParameters.Add(oPara);
        }
        ...
        public void AddTimeStampPara(string Name, System.Byte[] Value, QueryParameterDirection Direction)
        {
            ...
            OleDbParameter oPara = new OleDbParameter(Name, OleDbType.DBTimeStamp);
            oPara.Direction = GetParaType(Direction);
            oPara.Value = oValue;
            this.oParameters.Add(oPara);
        }
        ...
        {
            OleDbParameter oPara = new OleDbParameter(Name, OleDbType.VarBinary);
            oPara.Direction = GetParaType(Direction);
            oPara.Value = oValue;
            this.oParameters.Add(oPara);
        }
        ...
        {
            OleDbParameter oPara = new OleDbParameter(Name, DBNull.Value);
        ...
        {
            object oValue = null;
            OleDbParameter oPara = null;

            ParaName = ParaName.Trim().ToLower();
            foreach (object oItem in this.oParameters)
            {
                oPara = (OleDbParameter)oItem;
        ...
        // ################## P R O P E R T I E S ##################
        #region Connection
        private OleDbDataConnection oConn = null;
        /// <summary>
        ...
        /// the same connection.
        /// </summary>
        public OleDbDataConnection Connection
        {
            set
            {
                oConn = value;
